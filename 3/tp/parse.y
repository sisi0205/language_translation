...
opt_DOUBLESTAR_NAME // Used in: pick_STAR_DOUBLESTAR
	: COMMA DOUBLESTAR NAME {free($3);}
	| %empty
	;
pick_STAR_DOUBLESTAR // Used in: varargslist
	: STAR NAME opt_DOUBLESTAR_NAME {free($2);}
	| DOUBLESTAR NAME {free($2);}
	;
...
import_as_name // Used in: import_as_names, star_COMMA_import_as_name
	: NAME AS NAME {free($1); free($3);}
	| NAME {free($1);}
	;
dotted_as_name // Used in: dotted_as_names
	: dotted_name AS NAME {free($3);}
	| dotted_name
	;
...
dotted_name // Used in: decorator, pick_dotted_name, dotted_as_name, dotted_name
	: NAME {free($1);}
	| dotted_name DOT NAME {free($3);}
	;
global_stmt // Used in: small_stmt
	: GLOBAL NAME star_COMMA_NAME {$$=0; free($2);}
	;
star_COMMA_NAME // Used in: global_stmt, star_COMMA_NAME
	: star_COMMA_NAME COMMA NAME {free($3);}
	| %empty
	;
...
if_stmt // Used in: compound_stmt
	: IF test COLON suite star_ELIF ELSE COLON suite {$$=$4+$5+$8+1;}
	| IF test COLON suite star_ELIF {$$=$4+$5+1;}
	;
...
try_stmt // Used in: compound_stmt
	: TRY COLON suite plus_except opt_ELSE opt_FINALLY {if($6!=1) $$=$3+$4+1; else $$=0;}
	| TRY COLON suite FINALLY COLON suite {$$=0;}
	;
plus_except // Used in: try_stmt, plus_except 
	: plus_except except_clause COLON suite {$$=$1+$4+1;}
	| except_clause COLON suite {$$=$3+1;}
	;
...
classdef // Used in: decorated, compound_stmt
	: CLASS NAME LPAR opt_testlist RPAR COLON suite {$$=0; free($2);}
	| CLASS NAME COLON suite {$$=0;free($2);}
	;
