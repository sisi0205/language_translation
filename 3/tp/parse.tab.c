...
#line 2 "parse.y" /* yacc.c:339  */
	...
	int final=0;
	int func_comp=0;
	void output (std::stack< struct output> & st );
	struct output
	{
	    int line;
	    std::string fun_n;
...
#line 255 "parse.tab.c" /* yacc.c:358  */
...
{
       0,    64,    64,    67,    70,    71,    74,    75,    78,    79,
      82,    83,    86,    87,    90,    91,    94,   114,   115,   118,
     ...
     223,   226,   229,   230,   231,   232,   233,   236,   239,   242,
     243,   246,   249,   250,   253,   254,   257,   258,   261,   262,
     265,   268,   271,   272,   275,   276,   277,   280,   281,   284,
     285,   288,   289,   292,   293,   296,   297,   300,   301,   304,
     307,   308,   311,   312,   315,   316,   319,   320,   321,   322,
     ...
     421,   424,   425,   428,   429,   432,   433,   434,   435,   436,
     437,   438,   439,   440,   441,   442,   445,   446,   449,   450,
     453,   454,   457,   458,   461,   462,   465,   466,   469,   470,
     473,   474,   477,   478,   479,   480,   483,   484,   487,   488,
     489,   492,   493,   496,   497,   500,   501,   502,   503,   504,
     505,   506,   509,   510,   513,   514,   517,   518,   521,   522,
     525,   526,   529,   530,   533,   534,   537,   538,   541,   542,
     543,   546,   547,   550,   551,   554,   555,   556,   559,   560,
     563,   564,   567,   568,   571,   572,   575,   576,   579,   580,
     583,   584,   587,   588,   591,   592,   595,   596,   599,   600,
     603,   604,   607,   610,   611,   614,   615,   618,   619,   622,
     623,   624,   627,   628,   631,   632,   635,   636,   639,   640,
...
#line 95 "parse.y" /* yacc.c:1646  */
    {
	   ...
	   free((yyvsp[-3].string));
       if((yylsp[-4]).first_column==1)
       {
       stct_out.line=(yylsp[-4]).first_line;
	   stct_out.fun_n=(yyvsp[-3].string);
	   
	   stct_out.complex=(yyvsp[0].num)+1;
	   st.push(stct_out);
...
#line 229 "parse.y" /* yacc.c:1646  */
    {(yyval.num)=0;}
#line 2054 "parse.tab.c" /* yacc.c:1646  */
    break;
...
#line 304 "parse.y" /* yacc.c:1646  */
    {(yyval.num)=0; free((yyvsp[-1].string));}
...
#line 337 "parse.y" /* yacc.c:1646  */
    {(yyval.num)=(yyvsp[0].num)+(yyvsp[-3].num) +1; }
...
#line 341 "parse.y" /* yacc.c:1646  */
    {(yyval.num)=(yyvsp[0].num)+1+(yyvsp[-3].num);}
...
#line 345 "parse.y" /* yacc.c:1646  */
    {if((yyvsp[0].num)!=1) (yyval.num)=(yyvsp[-3].num)+(yyvsp[-2].num)+1; else (yyval.num)=0;}
...
#line 349 "parse.y" /* yacc.c:1646  */
    {(yyval.num)=(yyvsp[-3].num)+(yyvsp[0].num)+1;}
...
#line 599 "parse.y" /* yacc.c:1646  */
    {(yyval.num)=0; free((yyvsp[-5].string));}
#line 2396 "parse.tab.c" /* yacc.c:1646  */
    break;

  case 279:
#line 600 "parse.y" /* yacc.c:1646  */
    {(yyval.num)=0;free((yyvsp[-2].string));}
...
void output (std::stack< struct output> & st )
{
	while(!st.empty())
	{
	 std::cout<<"\(\""<<st.top().line<<":0:"<<" "<<"\'"<<st.top().fun_n<<"\'\""<<", "<<st.top().complex<<')'<<std::endl;
	 st.pop();
	}
}
