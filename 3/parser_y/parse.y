...
compound_stmt // Used in: stmt
	: if_stmt {complex+=1; fina_comp++;}
	| while_stmt {complex+=1; }
	| for_stmt {complex+=1; fina_comp++;  }
	| try_stmt { complex+=1; }
	| with_stmt
	| funcdef
	| classdef
...
try_stmt // Used in: compound_stmt
	: TRY COLON suite plus_except opt_ELSE opt_FINALLY { try_n=$1; }
	| TRY COLON suite FINALLY COLON suite { try_n=$1; }
	;
plus_except // Used in: try_stmt, plus_except {complex+=1; except+=1;fina_comp++;}
	: plus_except except_clause COLON suite {complex+=1;except+=1;fina_comp++;}
